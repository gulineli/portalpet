...
def grupo_menu(response,auth,grupo):
    response.menu = [#AUTORIZED_MENU([
        ##Junte-se a nos
        ((I(_class="fa fa-signin"),SPAN(' ',T('Junte-se a nós'),_class="menu-text") ),
         False, URL('grupos', 'junte_se_a_nos',args=(grupo.slug,)), [],False),
        ##Solicitações de Inclusões
        ((I(_class="fa fa-signin"),SPAN(' ',T('Solicitações de Inclusão'),' (%s)' %grupo.get_related('juntarse_grupo').count(),_class="menu-text") ),
         False, URL('grupos', 'validar_inclusoes',args=(grupo.slug,)), [],True),
        ##Mensagens
#        ((I(_class="fa fa-envelope"),SPAN(' ',T('Mensagens'),' (%s)' %grupo.get_related('juntarse_grupo').count(),_class="menu-text") ),
#         False, URL('grupos', 'grupo_message_box',args=(grupo.slug,)), [],True),
         ##Nosso Grupo
        ((I(_class="fa fa-group"),SPAN('  ',T('Nosso Grupo'),_class="menu-text") ),
         False, "",
         [
        ...
        ##Atividades
        ((I(_class="fa fa-calendar"),SPAN(' ',T('Atividades'),_class="menu-text") ),
         False, URL('grupos', 'atividades',args=(grupo.slug,)), [],True),
        ##Arquivos
        ((I(_class="fa fa-folder-open"),SPAN(' ',T('Arquivos'),_class="menu-text")),
         request.function=='arquivos', URL('grupos', 'arquivos',args=(grupo.slug,)), [],True),
        ##Reuniões
        ((I(_class="fa fa-book"),SPAN(' ',T('Reuniões'),_class="menu-text") ),
         False, "",
         [
        ...
        ##Cadastrar
        ((I(_class="fa fa-archive"),SPAN(' ',T('Cadastrar'),_class="menu-text") ),
        ...
        ##Gerenciar
        ((I(_class="fa fa-compass"),SPAN(' ',T('Gerenciar'),_class="menu-text") ),
         False, URL('grupos', 'grupo_message_box',args=(grupo.slug,)),
         [
        ...
        ##Configurações
        ((I(_class="fa fa-cogs"),SPAN(' ',T('Configurações'),_class="menu-text") ),
         False, URL('grupos', 'grupo_message_box',args=(grupo.slug,)),
         [
