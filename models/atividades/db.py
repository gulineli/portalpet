...
db.define_table('atividade_congresso',
    ...
    Field('carta_aceite','text',comment=u"Insira o texto que deve ir para a carta de aceite. A carta de aceite será submetida quando o artigo for aprovado. Utilize 'artigo.autores' para inserir os autores do artigo, 'artigo.titulo' para inserir o titulo do artigo, 'atividade.nome' para inserir o nome da atividade e 'atividade.periodo' para inserir o periodo de realização da atividade",widget=bootstrap_editor),
