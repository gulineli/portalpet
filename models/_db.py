...
#    Field('contato_id','integer'),
    ...
    Field('instrucoes','text',label=u'Instruções',comment="Utilize este campo para passar as instruções relativas as inscrições aos usuários do portal"),
    Field('msgonerror','text',comment=u"Utilize este campo para passar informações para que os usuários que estão encontrando dificuldade em se inscrever consigam resolver."),
    Field('tutorial','text',comment=u"Faça um breve tutorial de inscrição."),
